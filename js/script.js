...
$(()=>{
    ...
    $(document)
        ...
        .on('click','.card_submit',function(){
            ...
            $('.stamp img')[0].src = './사진/stamp-1.png';
            return alert('이벤트에 참여해주셔서 감사합니다.');
        })
})
        ...
        html +=`
            <div class="card">
                <div class="position-relative w-100 h-100 card_3d" data-id="${e.most}">
                    ...
                    <div class="back position-absolute w-100 h-100 d-flex justify-content-center align-items-center"><img src="./특산품/${e['area']}_${e['most']}.jpg" alt=""><p class="position-absolute p-1 d-none">${e.area}</p></div>
                </div>
            </div>
        `;
    })
